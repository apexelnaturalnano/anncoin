...
contract ANNToken is BurnableToken,FreezeToken, DetailedERC20, ERC20Token,Pausable{
	using SafeMath for uint256;
	...
	string public constant name = "Apexel Natural Nano";
	uint8 public constant decimals = 18;
	
	uint256 public constant TOTAL_SUPPLY = 75*(10**8)*(10**uint256(decimals));
